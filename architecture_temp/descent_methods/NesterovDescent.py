...
class NesterovDescent(FirstOrderDescentMethod):
    ...
    def __init__(self, initial_point, objective_function: Callable, objective_function_args: dict = {},
                 ...
                 use_auto_differentiation: bool = True, alpha=0.01, beta=0.01, tolerance=0.0001, max_function_calls=50):
    ...
    def optimize(self):
        ...
        while self.max_function_calls > self._function_calls and np.linalg.norm(x_curr - x_prev) > self.tolerance:
            ...
            gradient = self._call_gradient_function(x_curr + self.beta * v)

            v = self.beta * v - self.alpha * gradient
            x_curr = x_prev + v
